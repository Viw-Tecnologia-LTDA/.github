# VIWSEC Tecnologia LTDA

A VIWSEC é uma empresa de tecnologia focada em soluções de segurança da informação, gestão de vulnerabilidades, DevSecOps e inteligência de risco cibernético.
...
- Centralizar resultados de scanners de segurança
...
Os projetos internos da VIWSEC seguem boas práticas de:
...
Este repositório contém apenas informações institucionais.  
Os projetos internos e códigos-fonte não são públicos.
